...
##### Cloning the repository:  
 ```bash 
 https://github.com/adeline-pepela/Instagram-App.git 
```
...
* [![License](https://img.shields.io/packagist/l/loopline-systems/closeio-api-wrapper.svg)](https://github.com/adeline-pepela/Instagram-App/blob/master/LICENSE)  
* Copyright (c) 2022 
**Adeline Makokha**